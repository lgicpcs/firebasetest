...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            ValueEventListener dataListener = new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    edit_ID.setText(get.id);
                    edit_Name.setText(get.name);
                    edit_Age.setText(get.age.toString());
                    if(get.gender.equals("Man")){
                    ...
                    if (get.stars != null && get.stars.get("ttt") != null) {
                        Toast.makeText(MainActivity.this, get.stars.get("ttt").toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Query data = mPostReference.child("id_list").child(tempData[0].trim()).orderByKey();
    ...
    public void postFirebaseDatabase(boolean add){
        ...
        if(add){
            FirebasePost post = new FirebasePost(ID, name, age, gender, stars);
    ...
    public void getFirebaseDatabase(){
        ...
        Query sortbyAge = mPostReference.child("id_list").orderByChild(sort);
